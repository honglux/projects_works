...
/**
 * The class <code>HookProxyBeanTest</code> contains tests for the class <code>{@link HookProxyBean}</code>.
 *
 * @generatedBy CodePro at 11/27/17 1:01 PM
 * @author miyu3
 * @version $Revision: 1.0 $
 */
public class HookProxyBeanTest {
	/**
	...
	public void testAddDirectory_1()
		throws Exception {
		HookProxyBean fixture = new HookProxyBean();
		long companyId = 1L;
		...
		//    java.lang.ClassNotFoundException: com.liferay.documentlibrary.util.HookProxyBean
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(HookProxyBeanTest.class);
	}
}