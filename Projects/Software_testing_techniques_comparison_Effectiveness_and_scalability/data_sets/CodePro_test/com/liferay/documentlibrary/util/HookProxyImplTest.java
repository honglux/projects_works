...
/**
 * The class <code>HookProxyImplTest</code> contains tests for the class <code>{@link HookProxyImpl}</code>.
 *
 * @generatedBy CodePro at 11/27/17 1:01 PM
 * @author miyu3
 * @version $Revision: 1.0 $
 */
public class HookProxyImplTest {
	/**
	...
	public void testAddDirectory_1()
		throws Exception {
		HookProxyImpl fixture = new HookProxyImpl();
		long companyId = 1L;
		...
		//    java.lang.ClassNotFoundException: com.liferay.documentlibrary.util.HookProxyImpl
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(HookProxyImplTest.class);
	}
}