...
/**
 * The class <code>CyrusServiceImplTest</code> contains tests for the class <code>{@link CyrusServiceImpl}</code>.
 *
 * @generatedBy CodePro at 11/27/17 1:06 PM
 * @author miyu3
 * @version $Revision: 1.0 $
 */
public class CyrusServiceImplTest {
	/**
	 * Run the void addUser(long,String,String) method test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 11/27/17 1:06 PM
	...
	public void testAddUser_1()
		throws Exception {
		CyrusServiceImpl fixture = new CyrusServiceImpl();
		long userId = 1L;
		String emailAddress = "";
		String password = "";

		fixture.addUser(userId, emailAddress, password);

		// add additional test code here
		// An unexpected exception was thrown in user code while executing this test:
		//    java.lang.ClassNotFoundException: com.liferay.mail.service.impl.CyrusServiceImpl
	...
	/**
	 * Run the void deleteUser(long) method test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 11/27/17 1:06 PM
	 ...
	 */
	@Test
	public void testUpdatePassword_3()
		throws Exception {
		CyrusServiceImpl fixture = new CyrusServiceImpl();
		long companyId = 1L;
		long userId = 1L;
	 ...
	 */
	@Test
	public void testUpdatePassword_4()
		throws Exception {
		CyrusServiceImpl fixture = new CyrusServiceImpl();
		long companyId = 1L;
		long userId = 1L;
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(CyrusServiceImplTest.class);
	}
}