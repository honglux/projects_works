...
/**
 * The class <code>GoogleHookTest</code> contains tests for the class <code>{@link GoogleHook}</code>.
 *
 * @generatedBy CodePro at 11/27/17 1:10 PM
 * @author miyu3
 * @version $Revision: 1.0 $
 */
public class GoogleHookTest {
	/**
	 * Run the GoogleHook() constructor test.
	 *
	 * @generatedBy CodePro at 11/27/17 1:10 PM
	 */
	@Test
	public void testGoogleHook_1()
		throws Exception {
		GoogleHook result = new GoogleHook();
	...
	public void testAddForward_1()
		throws Exception {
		GoogleHook fixture = new GoogleHook();
		long companyId = 1L;
		long userId = 1L;
		...
		//    java.lang.ClassNotFoundException: com.liferay.mail.util.GoogleHook
	 ...
	 */
	@Test
	public void testDeleteEmailAddress_3()
		throws Exception {
		GoogleHook fixture = new GoogleHook();
		long companyId = 1L;
		long userId = 1L;
	 ...
	 */
	@Test
	public void testDeleteEmailAddress_4()
		throws Exception {
		GoogleHook fixture = new GoogleHook();
		long companyId = 1L;
		long userId = 1L;
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(GoogleHookTest.class);
	}
}